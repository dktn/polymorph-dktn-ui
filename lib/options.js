...
export default {
    apply: function() {
        ...
        var writeCustomStyles = function(themeColor, indentGuideColor, invisiblesColor, fontSize, lineHeight, ratioNoHover, ratioHover, tabHeight, options){
            if (isHexCode(themeColor) && isHexCode(indentGuideColor) && isHexCode(invisiblesColor)) {
                var custom =
        ...
        var saveCustomSettings = function() {
            ...
            styleTimer = setTimeout(function() {
                ...
                writeCustomStyles(themeColor, indentGuideColor, invisiblesColor, fontSize, lineHeight, ratioNoHover, ratioHover, tabHeight);
            }, 1000);
        };
