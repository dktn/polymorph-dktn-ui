...
export default {
    apply: function() {
        ...
        var writeCustomStyles = function(color, fontSize, lineHeight, ratioNoHover, ratioHover, options){
            if (isHexCode(color)) {
                var custom =
                       '@theme-color: '           + color +
        ...
        var saveCustomSettings = function() {
            ...
            styleTimer = setTimeout(function() {
                ...
                writeCustomStyles(themeColor, fontSize, lineHeight, ratioNoHover, ratioHover);
            }, 1000);
        };
