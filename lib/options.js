...
export default {
    apply: function() {
        ...
        var writeCustomStyles = function(themeColor, indentGuideColor, invisiblesColor, gutterColor, gutterCursorColor,
                                         fontSize, lineHeight, ratioNoHover, ratioHover, tabHeight, options){
            if (isHexCode(themeColor) && isHexCode(indentGuideColor) && isHexCode(invisiblesColor) && isHexCode(gutterColor) && isHexCode(gutterCursorColor)) {
                var custom =
        ...
        var saveCustomSettings = function() {
            ...
            styleTimer = setTimeout(function() {
                ...
                writeCustomStyles(themeColor, indentGuideColor, invisiblesColor, gutterColor, gutterCursorColor, fontSize, lineHeight, ratioNoHover, ratioHover, tabHeight);
            }, 1000);
        };
